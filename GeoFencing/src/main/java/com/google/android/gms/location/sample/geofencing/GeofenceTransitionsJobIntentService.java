...
public class GeofenceTransitionsJobIntentService extends JobIntentService {
    ...
    private static final String CHANNEL_ID = "channel_01123";
    ...
    private void sendNotification(String notificationDetails , String event,String Latitude,String Longitude) {
        ...
        final String message = notificationDetails;
        ...
        Intent notificationIntent = new Intent(getApplicationContext(), NotificationReceiverActivity.class);
...
//                .addAction(R.drawable.ic_launcher, "Punch In", notificationPendingIntent)
//                .addAction(R.drawable.ic_launcher, "Punch Out", notificationPendingIntent);
        ...
        // saving and updating data inside the local data
